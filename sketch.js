...
function preload(){
    //preloading images, animations and sounds 
...
function draw() {
    ...
    //calling functions in play state
    if(gameState===PLAY){
      //creating score
     distance = distance + Math.round(getFrameRate()/50);
     path.velocityX = -(6 + 2*distance/150);

      //making the main cyclist move according to mouse's y position
    ...
    fill("white");
    textSize(20);
    text("Press Up Arrrow to Restart the Game!", 490, 200);
